...
@media(pointer:coarse){button{min-height:44px}}
 ...
 dialog{width:calc(100vw - 16px);height:calc(100dvh - 16px);border-radius:8px}dialog[open]{display:flex;flex-direction:column}header{flex:none;padding:10px 16px;gap:12px}h2{font-size:18px}header p{margin:2px 0 0;font-size:13px}.editor-body{height:auto;flex:1;min-height:0;overflow:hidden}button{min-height:32px;font-size:14px;padding:5px 12px}.discard{top:65px}.editor-body :global(.question-workspace){height:100%}@media(max-width:600px){.editor-body{height:auto}header{padding:8px 12px}.actions{width:auto}.actions span{display:none}}
 </style>
