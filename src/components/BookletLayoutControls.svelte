...
<style>
.layout-controls{padding:12px;border:1px solid var(--border,#ccd5df);border-radius:6px;margin-bottom:12px;font:14px system-ui;color:var(--text,#243348);background:var(--panel,#fff)}.heading,.fields{display:flex;align-items:center;gap:12px;flex-wrap:wrap}.heading{margin-bottom:12px}.heading strong{margin-right:auto}label{display:inline-flex;align-items:center;gap:8px;flex-wrap:wrap}input{width:85px}input,select,button{font:inherit;min-height:36px;border:1px solid var(--border,#b8c6d5);border-radius:4px;background:var(--panel,#fff);color:inherit;padding:4px 8px;box-sizing:border-box}.layout-divider{position:relative;display:flex;justify-content:space-between;align-items:center;margin:12px 0;background:var(--surface,#eaf1f8);min-height:44px;padding:0 10px}.layout-divider [role=separator]{min-height:36px;min-width:36px;display:grid;place-items:center;background:var(--panel,#fff);border:1px solid var(--border,#b8c6d5);border-radius:4px;position:absolute;transform:translateX(-50%);touch-action:none;cursor:ew-resize}p{color:#a52b20}@media(pointer:coarse){input,select,button{min-height:44px}}
</style>
